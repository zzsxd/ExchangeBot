...
class ConfigParser:
    ...
    def change_course_buy(self, new_path):
        self.__current_config['coursebuy'] = new_path
        self.create_conf(self.__current_config)

    def change_course_sell(self, new_path):
        self.__current_config['coursesell'] = new_path
        self.create_conf(self.__current_config)